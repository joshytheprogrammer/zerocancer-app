  ...
  return (
    <div className="wrapper flex flex-col lg:flex-row items-center justify-between gap-12 bg-primary text-white py-12">
      <div className="lg:w-1/2 space-y-8">
        <h1 className="text-4xl lg:text-5xl font-bold">Embark on Your Path to Wellness with ZeroCancer</h1>
        <p className="text-lg">
      ...
      <div className="flex justify-end">
        <img src={heroImg} alt="image of a woman" className="w-full lg:w-9/10"/>
      </div>
    </div>
  );
}
