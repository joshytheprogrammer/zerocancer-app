...
export default function Fight() {
  return (
   <div className="wrapper py-20 flex flex-col items-center space-y-8"> 
     <h1 className="text-4xl lg:text-5xl  font-bold text-center">How We Help You Fight Cancer</h1>
     <p className="text-center max-w-3xl">From screening to treatment, we guide you every step of the way.</p>
     <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 w-full">
        <div className="h-72 bg-blue-200 w-full rounded-2xl p-6 space-y-1 flex flex-col justify-between">
            <div className="space-y-2">
                ...
                <p className="max-w-2xs text-sm text-neutral-500">We help you get screened for common cancers.</p>
            </div>
        ...
        <div className="h-72 bg-purple-200 w-full rounded-2xl p-6 space-y-1 flex flex-col justify-between">
            <div className="space-y-2">
                ...
                <p className="max-w-2xs text-sm text-neutral-500">We connect you to trusted hospitals and care.</p>
            </div>
            <div className="flex justify-end">
        ...
        <div className="h-72 bg-green-200 w-full rounded-2xl p-6 space-y-1 flex flex-col justify-between">
            <div className="space-y-2">
                ...
                <p className="max-w-2xs text-sm text-neutral-500">Need more help? We link you to the right experts.</p>
            </div>
            <div className="flex justify-end">
