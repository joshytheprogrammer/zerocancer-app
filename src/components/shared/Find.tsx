  ...
  return (
    <div className="wrapper py-20 grid md:grid-cols-2 gap-10 items-center">
      <div className="space-y-6">
        <h2 className="text-4xl lg:text-5xl font-bold">Find a Screening Center Near You</h2>
        <p className="text-muted-foreground">
          Search for cancer screening centers and order test kits easily, wherever
          you are.
        </p>
        ...
        <button className="px-8 py-2 bg-secondary text-white rounded-lg">Find Centers</button>
      </div>
