  ...
  return (
    <div className="wrapper py-20 flex flex-col lg:flex-row items-center gap-8">
      <div className='lg:w-1/2'>
        ...
        <p className="text-muted-foreground mt-4">Short, helpful videos to guide you through understanding, testing, and taking control of your health.</p>
        ...
        <div className="mt-4 space-y-4">
          <div className="flex items-center gap-4 p-4 border rounded-lg">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">Understand the risks, symptoms, and importance of early detection.</p>
            </div>
          ...
          <div className="flex items-center gap-4 p-4 border rounded-lg">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">Follow these easy steps to collect your sample correctly.</p>
            </div>
            <button className="ml-auto bg-secondary text-white p-2 rounded-full flex items-center justify-center">
              <Play />
            </button>
