  ...
  if (!payment) {
    return (
      <StatusCard
        ...
        message="We couldn't find a payment with this reference. Please check your payment confirmation email or contact support."
      />
    )
  }
        ...
        <div className="max-w-2xl w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Your campaign has been successfully funded. Here are the details
              of your transaction.
            </p>
          </div>
